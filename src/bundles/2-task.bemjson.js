              ...
              content: [
                {
                  ...
                  content: [
                    ...
                    {elem: 'input', tag: 'input', cls: 'input', attrs: {id: 'login', name: 'login', type: 'text', placeholder: 'Артём Звездилин'}},
                  ],
                },
                {
                  ...
                  content: [
                    ...
                    {elem: 'input', tag: 'input', cls: 'input', attrs: {id: 'password', name: 'password', type: 'password'}},
                  ],
                },
              ],
            },
